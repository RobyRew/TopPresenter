...
struct BibleView: View {
    ...
    /// Import is one sheet, hosted once in MainControlView. This tab only says
    /// "open it, preselecting Bibles" — the other files in a dropped folder are
    /// still shown, just not silently included.
