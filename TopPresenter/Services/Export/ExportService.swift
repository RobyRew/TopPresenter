...
final class ExportService {
    ...
    static func exportBible(
        ...
        // `format` remains a parameter because the call sites read better for
        // it, and because a second WRITABLE format is plausible later. What is
        // gone is the lossy pair.
        let content = try await exportToTopPresenterJSON(module: module, progressHandler: progressHandler)
    ...
    static func exportSongs(
        ...
        let content = try await exportSongsToTopPresenterJSON(collection: collection, progressHandler: progressHandler)
